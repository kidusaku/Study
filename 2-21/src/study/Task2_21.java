...
/**
 * 本課題では、代表的なコレクションフレームワークのArrayList及びHashMapを使い くだものとその値段を管理するコードを記述します。
 * 
 * 問①～問④まであります。
 * 
 */
public class Task2_21 {
    ...
    public static void main(String[] args) {
        ...
        fruitsHashMap.put(apple, 200);
        // ④ レッスン内容を参考に拡張for文を使い、
        // 実行結果がターミナルと同じように表示されるよう出力して下さい。
        for (String fruitst : fruitsHashMap.keySet()) {
            System.out.println(fruitst + "の値段は" + fruitsHashMap.get(fruitst) + "です。");
        }
    }
